...
public final class PrettyPrinter {
    ...
    /**
     * Returns a pretty-printer object to format output
     * @param out: Sets the printstream
     * @param asNull: Placeholder
     * @since 0.1
     */
    ...
    /**
     * Converts ArrayList of Strings to Strings
     * @param table: Table of arraylist&lt;String&gt;
     * @since 0.1
     */
    public void convert(ArrayList<String> table[][])
    {
        String t[][]=new String[table.length][table[0].length];
        int i,j;
