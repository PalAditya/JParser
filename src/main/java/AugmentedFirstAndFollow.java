...
public class AugmentedFirstAndFollow
{
    ...
    /**
     * Performs LL(1) parsing (complete implementation not done-use at own discretion)
     * @param arr: The parsing table
    ...
    /**
     * Computes the first and follow sets for the grammar<br>
     ...
     * Either parses the Grammar file successfully, or exits with error code -1<br>
     * @param filename: Path to file to read grammar from
     * @param augment: Whether to compute first follow for augmented grammar too
     * @param output: Whether to output the computed first and follow
