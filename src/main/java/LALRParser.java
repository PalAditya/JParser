...
public class LALRParser extends Parser
{
    ...
    /**
     * new_map: Creates a hashmap to maintain link between LR1 and LALR states
     * @since 0.1
     */
    public LALRParser()
    {
    ...
    /**
     * Builds the LALR dfa (same as LR1 dfa)
     * @since 0.1
     */
    ...
    /**
     * Generates the parsing table and returns whether the grammar is LALR or not
     * @return boolean
